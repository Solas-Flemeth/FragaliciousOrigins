...
public class Werewolf extends Origin {
    ...
    private void updateArmor(){
        ...
        double newAttackSpeed = configAttackSpeed * (1.0 -( WEREWOLF_CONFIG.getAttackPenaltyArmor() * armor + toughness * WEREWOLF_CONFIG.getAttackPenaltyToughness()));
        double newMovementSpeed = configMovementSpeed * (1.0- ( WEREWOLF_CONFIG.getSpeedPenaltyArmor() * armor + toughness * WEREWOLF_CONFIG.getSpeedPenaltyToughness()));
        PlayerUtils.setAttribute(player,Attribute.GENERIC_ATTACK_SPEED, newAttackSpeed);
        PlayerUtils.setAttribute(player,Attribute.GENERIC_MOVEMENT_SPEED, newMovementSpeed);
    }
